...
Cohesion: 0.05
Nodes (48): ExplorePage(), matchesSelection(), LandingPage(), BoardSkeleton(), DepartureBoardProps, DepartureRow, FlapText(), FlapTextProps (+40 more)
...
Cohesion: 0.23
Nodes (7): Status, PersonLabel(), Button(), ButtonProps, DirectoryUser, FriendEntry, FriendsResponse
...
Cohesion: 0.12
Nodes (29): FriendsPage(), Mode, InviteCard(), addGroupMember(), CitiesParams, deleteGroup(), getFriends(), getGroup() (+21 more)

### Community 35 - "Community 35"
Cohesion: 0.22
Nodes (4): Mode, buildDensity(), GroupTripsCalendar(), GroupTripsCalendarProps
...
## Knowledge Gaps
- **248 isolated node(s):** `TripPopoverProps`, `TIER_BADGE`, `TripTooltipProps`, `CountryFlagProps`, `SheetProps` (+243 more)
