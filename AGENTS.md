...
- **Country favourites + settings autosave (2026-07-23):** Settings accepts either a city or country in Favourite destinations. Choosing a country expands to every catalogued IATA code in that country, preserving the existing city-based relaxed fare queries, Explore pinning/filtering, and calendar gold-star treatment; complete countries collapse into a single gold bubble in Settings. Preference changes autosave through a serialized client queue; the manual “Save preferences” button is removed.
